...
export default function Home() {
  return (
    <div className="bg-slate-50 grainy-light">
      <section>
        {/* classNameExtra : ini tambahan className utk componentnya */}
        <MaxWidthWrapper classNameExtra="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              {/* Pages Header-1 Snake Picture */}
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  <li className="flex gap-1.5 items-center text-left">
                    {/* css : shrink-0 = so the Check will not be smaller than the value of height and width stated */}
          ...
          w-full flex justify-center px-8 sm:px-16 
          ...
          >
            <div className="relative md:max-w-xl">
              <img
                ...
                lg:w-52 left-56 -top-20 select-none
      ...
      >
        <MaxWidthWrapper
          classNameExtra="flex flex-col 
        items-center gap-16 sm:gap-32"
        >
          <div
      ...
      {/*  */}
      <section>
        <MaxWidthWrapper classNameExtra="py-24">
          {/* H2 words */}
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2
                className="order-1 mt-2 tracking-tight 
              text-center text-balance !leading-tight 
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            items-center md:grid grid-cols-2 gap-40"
            >
              <img
                src="/arrow.png"
                className="absolute top-[25rem] 
                md:top-1/2 -translate-y-1/2 z-10 
